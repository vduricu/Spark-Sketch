<div class="content adminContent">
	<div class="aSMenu">
		<a href="./?zona=discutii&pagina=lista" class="current">Lista Mesaje Acceptate <span>(<?php __(howMany("discuss","status","approved"))?>)</span></a>&nbsp;
	...
	<table border="1" class="table_data" id="discuss">
		...
		<tbody>
		<?php
		$q=mysql_query("SELECT * FROM `discuss` WHERE `status`='approved' ORDER by `data` DESC");
		$i=0;
