<div class="content adminContent">
	<div class="aSMenu">
		...
		|&nbsp;<a href="./?zona=discutii&pagina=waiting" class="current">Mesaje in asteptare <span>(<?php __(howMany("discuss","status","waiting"))?>)</span></a>&nbsp;
	...
	<table border="1" class="table_data" id="discuss">
		...
		<tbody>
		<?php
		$q=mysql_query("SELECT * FROM `discuss` WHERE `status`='waiting' ORDER by `data` DESC");
		$i=0;
