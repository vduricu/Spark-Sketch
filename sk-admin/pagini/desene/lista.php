<div class="content adminContent">
	<div class="aSMenu">
		<a href="./?zona=desene&pagina=lista" class="current">Lista Desene Acceptate <span>(<?php __(howMany("draws","status","approved"))?>)</span></a>&nbsp;
	...
	<form action="admin.php?zona=draws&pagina=mdelete" method="POST">
	<table border="1" class="table_data" id="draws">
		...
		?>
			<tr <?php __($trClass)?>>
				...
				<td style="width: 22%; text-align: center;"><?php __($r['creationdate'])?></td>
				<td style="width: 22%; text-align: center;"><?php __($r['modificationdate'])?></td>
				<td style="width: 5%;text-align: center;clear: both;">
		...
		<tfoot>
			<tr>
				<td colspan="7" style="text-align: right"><input type="submit" class="button" value="Sterge"/></td>
			</tr>
		</tfoot>
	</table>
	</form>
