...
<table>
	...
	<tr>
		<th colspan="2"><input type="button" class="button" value="<?php ___("cancel")?>" onClick="$(document).trigger('close.facebox');">  <input type="submit" class="button" id="saveButton" value="<?php ___("save")?>" onClick="return saveCanvasDemo()"></th>
	</tr>
</table>
